...
//		when(statementService.getStatementByIdAndStatementId(22, 1)).thenReturn(new Statement());
//
//		// Get Statement
//		Statement statement = customerController.getStatementByIdAndStatementId(22, 1);
//
//		// test statement
...
//
//		// Mock Statement service
//		when(statementService.getStatementByIdAndCardNumber(22, "5241 6701 2345 6789")).thenReturn(new Statement());
//
//		// Get Statement
//		Statement statement = customerController.getStatementByIdAndCardNumber(22, "5241 6701 2345 6789");
//
//		// test statement
//		assertThat(statement).isNotNull();
//	}
...
//
//		// Mock Statement service
//		when(statementService.getStatementsByIdAndCardNumber(22, "5241 6701 2345 6789"))
//				.thenReturn(new ArrayList<Statement>());
//
//		// Get Statement
//		List<Statement> statements = customerController.getAllStatementsByIdAndCardNumber(22, "5241 6701 2345 6789");
//
//		// test statement
...
//
//		// Mock Statement service
//		when(statementService.getStatementsByIdAndCardNumber(1, "5241 6701 2345 6789")).thenReturn(null);
//
//		// Get Statement
//		List<Statement> statements = customerController.getAllStatementsByIdAndCardNumber(22, "5241 6701 2345 6789");
//
